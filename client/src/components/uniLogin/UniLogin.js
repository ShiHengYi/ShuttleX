...
class UniLogin extends Component{
			  ...
			  <div className="col-sm-6">
			    <div className="card bg-transparent border-secondary mb-3">
			      <div className="card-body">
			        ...
			        <Link className="btn btn-info" id="unilogin_title"  to='/loginDriver'>
            		Driver Sign In
            		</Link>
			      </div>
			    </div>
			  ...
			  <div className="col-sm-6">
			    <div className="card bg-transparent border-secondary mb-3">
			      <div className="card-body">
			        ...
			        <Link className="btn btn-info" id="unilogin_title"  to='/loginRider'>
            		Rider Sign In
            		</Link>
			      </div>
			    </div>
