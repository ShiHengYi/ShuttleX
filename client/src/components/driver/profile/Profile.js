  ...
  return (  
	<div className="card mb-3">
        <div className="card-header">
          <i className="fa fa-area-chart"></i> Edit/Update Profile
        </div>
        ...
        <form className="form-horizontal" role="form">
          ...
          <div className="form-group">
            ...
            <div className="col-md-8">
              <input className="form-control" type="password" name="passwordInput" value={this.state.passwordInput} onChange={this.handleChange}/>
            </div>
          </div>
          <div className="form-group">
            <label className="col-md-3 control-label">Confirm password:</label>
            <div className="col-md-8">
              <input className="form-control" type="password" name="confirmPasswordInput" value={this.state.confirmPasswordInput} onChange={this.handleChange} />
            </div>
          </div>
          {this.state.error? 
          <div className="alert alert-danger" role="alert">
